          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex flex-col sm:flex-row flex-wrap gap-2 w-full md:w-auto md:items-center">
              ...
              <Select
                ...
                onValueChange={value => setSelectedMachineType(value || "all")}
              >
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex flex-col sm:flex-row flex-wrap gap-2 w-full md:w-auto md:items-center">
              ...
              <Select
                ...
                onValueChange={value => handleDocumentMachineTypeChange(value || "all")}
              >
                <SelectTrigger className="w-full sm:w-[180px] md:w-[200px]">
                  <SelectValue placeholder="Filter by Machine Type" />
                </SelectTrigger>
              ...
              <Select
                ...
                onValueChange={value => setSelectedDocumentMachine(value || "all")}
              >
                <SelectTrigger className="w-full sm:w-[180px] md:w-[200px]">
