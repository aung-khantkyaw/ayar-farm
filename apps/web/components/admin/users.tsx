                  ...
                  <div className="grid gap-4 py-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleFormChange("userType", value as string)
                        }
                      >
                        <SelectTrigger>
            ...
            <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center">
              ...
              <div className="flex flex-col sm:flex-row gap-2 items-start sm:items-center flex-wrap">
                <div className="flex items-center gap-2">
                  ...
                  <Select value={filterRole} onValueChange={(value) => setFilterRole(value as string)}>
                    <SelectTrigger
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setFilterVerified(value as string)}
                  >
                    <SelectTrigger
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => {
                      setUsersPerPage(Number(value as string));
                      setCurrentPage(1);
                    }}
                  >
                    <SelectTrigger
