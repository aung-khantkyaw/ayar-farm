  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const updatedData = {
        ...
        location:
          `${states.find((s) => s.id === selectedState)?.en || ""} ${townships.find((t) => t.id === selectedTownship)?.name?.en || townships.find((t) => t.id === selectedTownship)?.name || ""} ${formData.location}`.trim(),
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handleSelectChange("gender", value || "Select gender")
                }
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handleSelectChange("userType", value || "Select user type")
                }
              >
                <SelectTrigger>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select
                  value={selectedState}
                  onValueChange={(value) =>
                    handleStateChange(value || "Select state")
                  }
                >
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setSelectedTownship(value || "Select township")
                  }
                >
                  <SelectTrigger>
