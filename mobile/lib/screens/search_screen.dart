...
class _SearchScreenState extends State<SearchScreen> {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          _groups = (groupResponse['data'] as List?)?.map((e) => Conversation.fromJson(e)).toList() ?? [];
          _isLoading = false;
        });
      }
    } catch (e) {
  ...
  Future<void> _showGroupInfo(Conversation group) async {
    ...
    final textMainColor = isDark ? const Color(0xFFE1E6E2) : const Color(0xFF111813);
    final textSubColor = isDark ? const Color(0xFF8BA892) : const Color(0xFF61896B);
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text('${group.participants.length} members', style: TextStyle(color: textSubColor)),
          ],
        ),
        actions: [
          TextButton(
  ...
  Widget build(BuildContext context) {
    ...
    final surfaceColor = isDark ? const Color(0xFF102215) : const Color(0xFFFFFFFF);
    final surfaceHighlightColor = isDark ? const Color(0xFF1E3626) : const Color(0xFFF0F4F1);
    final textMainColor = isDark ? const Color(0xFFE1E6E2) : const Color(0xFF111813);
    final textSubColor = isDark ? const Color(0xFF8BA892) : const Color(0xFF61896B);
    final borderColor = isDark ? const Color(0xFF1E3626) : const Color(0xFFF9FAFB);
      ...
      body: _isLoading
          ...
          : ListView(
              children: [
                ...
                if (_users.isEmpty && _groups.isEmpty && _searchController.text.isNotEmpty && !_isLoading)
                  Center(
                    child: Padding(
